...
- Optional live selector audit with `tests/audit-live-dom.mjs --port 9341`;
  this parses the CSS in a detached document and only counts current Codex DOM
  matches without injecting or changing visible UI.
